...
complete --command yt-dlp --long-option live-from-start --description 'Download livestreams from the start. Currently experimental and only supported for YouTube, Twitch, TVer, and mellow-fan'
